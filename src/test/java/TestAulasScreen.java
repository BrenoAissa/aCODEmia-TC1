...
public class TestAulasScreen {
    ...
    public void shouldOpenSiteAndDontFillUserInfosWithErrorReturn() {
        final WebElement input = new WebDriverWait(driver, Duration.ofSeconds(WAITTIME)).
                until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_INSERIR_CPF)));
        ...
        final WebElement buttonIncluir = new WebDriverWait(driver, Duration.ofSeconds(WAITTIME))
                .until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_BUTTON_INSERT)));
        buttonIncluir.click();
        final WebElement buttonFinalizar = new WebDriverWait(driver, Duration.ofSeconds(WAITTIME))
                .until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_BUTTON_FINALIZAR)));
        buttonFinalizar.click();
        final WebElement buttonListar = new WebDriverWait(driver, Duration.ofSeconds(WAITTIME))
                .until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_BUTTON_LISTAR)));
        buttonListar.click();
        final WebElement contentTable = new WebDriverWait(driver, Duration.ofSeconds(WAITTIME))
                .until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_CONTENTTABLE)));
